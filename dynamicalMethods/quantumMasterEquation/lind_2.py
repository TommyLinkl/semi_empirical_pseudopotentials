...
def RK4_init(D_level_Ltilde,D_level_L,D_level_Rtilde,D_level_R, d_level,Ham, Rho, GammaL,GammaR): 
        ...
        Rho011L = lind_2.Lind_1lead(D_level_Ltilde,D_level_L,d_level, Ham, Rho, GammaL)
        Rho011R = lind_2.Lind_1lead(D_level_Rtilde,D_level_R,d_level, Ham, Rho, GammaR)

        return Rho0 + Rho011L+ Rho011R

def RK4(D_level_Ltilde,D_level_L,D_level_Rtilde,D_level_R, d_level,Ham, Rho, dt,GammaL,GammaR): 

        Rho_01 = lind_2.RK4_init(D_level_Ltilde,D_level_L,D_level_Rtilde,D_level_R, d_level,Ham, Rho, GammaL,GammaR)

        Rho_02 = lind_2.RK4_init(D_level_Ltilde,D_level_L,D_level_Rtilde,D_level_R, d_level,Ham, Rho+Rho_01*dt/2.0, GammaL,GammaR)

        Rho_03 = lind_2.RK4_init(D_level_Ltilde,D_level_L,D_level_Rtilde,D_level_R, d_level,Ham, Rho+Rho_02*dt/2.0, GammaL,GammaR)

        Rho_04 = lind_2.RK4_init(D_level_Ltilde,D_level_L,D_level_Rtilde,D_level_R, d_level,Ham, Rho+Rho_03*dt, GammaL,GammaR)
