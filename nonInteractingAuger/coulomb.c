...
void generate_coulomb_matrix_elements(double *vkijb,double *vkcab,double *psiai,double *evalai,double *sigeai,double *psibs,
  zomplex *potq,double *pothhl,lng_st ist,par_st par,fftw_plan_loc *planfw,fftw_plan_loc *planbw,fftw_complex *fftwpsi)
{
