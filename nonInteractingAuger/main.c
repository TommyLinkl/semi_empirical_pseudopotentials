...
int main(long argc, char *argv[]) {
  ...
  // TODO: remove below logic from main and put it into its own function:
  //store_sp_eigenstates(psibe, eval, de, ...)
  ...
  // TODO: uncomment these from above after logic is moved out of the main.c
  eval = (double*)calloc(ist.numBandEdgeStates,sizeof(double)); // band-edge, non-interacting energies 
  de = (double*)calloc(ist.numBandEdgeStates,sizeof(double)); // band-edge, non-interacting sigma values
  ...
  calculate_auger(vkijb,vkcab,eval,evalai,sigeai,ist,par);
