...
void calculateStrainScale(long nAtoms, double *tetrahedronVolRef, atm_st *atm,
        vector *atomNeighbors, double *a4Params, double *strainScale);
...
void writeCubeFile_cubicUnitCell(double *rho, par_st par, long_st ist, char *fileName, double xmin, double ymin, double zmin, double box_length);
